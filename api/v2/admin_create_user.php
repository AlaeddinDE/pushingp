...
$stmt = $conn->prepare('INSERT INTO members_v2 (name, email, discord_tag, roles, joined_at, status) VALUES (?,?,?,?,?,\'active\')');
if (!$stmt) {
...
api_log_admin_action($conn, api_current_user_id() ?? 0, 'admin_create_user', 'member', (string) $newId, $data);
