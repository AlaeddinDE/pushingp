...
$totalCount = 0;
$stmt = $conn->prepare("SELECT COUNT(*) FROM transactions_v2 WHERE status!='storniert'");
...
$reserved = 0.0;
$stmt = $conn->prepare("SELECT COALESCE(SUM(amount),0) FROM reservations_v2 WHERE status='active'");
