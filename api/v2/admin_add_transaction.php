...
$stmt = $mysqli->prepare('INSERT INTO transactions_v2 (member_id, type, amount, reason, status, event_id, metadata) VALUES (?,?,?,?,?,NULLIF(?,0),?)');
if (!$stmt) {
...
api_log_admin_action($mysqli, api_current_user_id() ?? 0, 'admin_add_transaction', 'transaction', (string) $newId, $data);
