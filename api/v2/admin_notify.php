...
$stmt = $conn->prepare('INSERT INTO discord_notifications (event_id, payload) VALUES (NULL, ?)');
if (!$stmt) {
...
api_log_admin_action($conn, api_current_user_id() ?? 0, 'admin_notify', 'notification', null, $payload);
